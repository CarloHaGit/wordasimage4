...
function drawType() {
  ...
  xHeight = actualHeight * 0.27745664739 + weightMap/2
  ...
  baseLine = actualHeight * 0.82851637764 - weightMap / 2;
...
function calculateAverage(min, max) {
  ...
  if (avgCounter < 400){ //46
    avgCounter++;
    avg = 90; //hier kalibriermöglichkeit?
  }
  ...
  if (frequencies == 50) {
    ...
    console.log("lowest: " + lowestAvg + " highest: " + highestAvg + " current: " + avg);
  }
